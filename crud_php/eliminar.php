...
$sql = $conexion->query("SELECT * FROM persona WHERE id_persona = $id"); #selecciono todos los datos de la tabla personas
...
<body>
    <form class="col-4 p-3 m-auto" method="POST"><!--agrego col-4 -->
        <h3 class="text-center text-secondary">eliminar Personas</h3> <!--agrego titulo de formulario y cambio color -->
        <input type="hidden" name="id" value="<?= $_GET[$id] ?>">
        <?php #inicio de codigo php
        include "controlador/eliminar_persona.php"; #incluyo el archivo modificar_persona.php
      ...
      <button type="submit" class="btn btn-primary" name="btneliminar" value="ok">Eliminar</button>
    </form>
</body>
</html>